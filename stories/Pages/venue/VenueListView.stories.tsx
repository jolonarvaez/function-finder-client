...
const MOCK_VENUES: MapVenue[] = [
  ...
  },
  {
    ...
    event: {
      name: "The Grid",
      image: "https://placehold.co/600x300/1c1917/f97316?text=The+Grid",
      address: "555 Electric Ave, East Side",
      category: "Club",
      startTime: "9PM",
      endTime: "3AM",
      featured: true,
      attending: 203,
      dj: { name: "Spectrum", avatar: "https://placehold.co/80x80/ea580c/fff?text=SP", genre: ["House", "Techno"] },
    },
  },
  {
    lng: 121.026,
...
const meta: Meta<typeof VenueListView> = {
  ...
  decorators: [
    (Story) => (
      <div className="mx-auto w-full max-w-xl overflow-hidden bg-background">
        <Story />
      </div>
    ),
  ],
