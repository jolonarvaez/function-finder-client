...
export function PrivacyPolicyContent() {
  return (
    <LegalContent title="Privacy Policy" lastUpdated="August 10, 2026">
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Function Finder PH.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country/State</strong> refers to: Philippines.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Function Finder PH, accessible from{" "}
            <a
              href="https://www.function-finder.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.function-finder.app/
            </a>
            .
          </p>
        </li>
      ...
      <ul>
        ...
        <li>
          <strong>Web Beacons.</strong> Certain sections of Our Service may contain small electronic
      ...
      <p>
        ...
        change Your consent at any time using Our cookie preferences tool (if available) or through
      ...
      <ul>
        ...
        <li>
          ...
          <p>Administered by: Us</p>
          <p>
            Purpose: These Cookies identify whether users have accepted the use of cookies on the
            Website and record the consent choices You have made, so that We can honor those choices
            on future visits.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            such as remembering Your Account login details or language preference. The purpose of
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            already purchased or inquired about. We send such marketing communications only where
            permitted by applicable law: where prior consent is required (for example, under the
            laws applicable in the EEA and the UK), We will send them only with Your consent;
      ...
      <ul>
        ...
        <li>
          ...
          may be viewed by all users and may be publicly distributed outside the Service.
        </li>
        <li>
      ...
      <ul>
        <li>
          By email: <a href="mailto:jolo.narvaez@gmail.com">jolo.narvaez@gmail.com</a>.
        </li>
      </ul>
    </LegalContent>
  );
