...
import { VENUE_FILTERS, VENUE_FILTER_LABELS, type VenueFilter } from "@/lib/constants";
...
export function VenueFilterSelector({ selected, onChange, className }: VenueFilterSelectorProps) {
  return (
